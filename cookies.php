...
x
			...
			.table td, .table>tbody>tr>td, .table>tbody>tr>th, .table>tfoot>tr>td, .table>tfoot>tr>th, .table>thead>tr>td, .table>thead>tr>th {
				...
				.col-lg-3 input[type='submit'], .col-lg-3 input[type='reset']{
					padding: 8px 15px;
					color: #555;
					margin-top: 0.5em;
					font-size: 17px;
				...
				.col-md-4 input[type='submit'], .col-md-4 input[type='reset']{
					padding: 7px 13px;
					color: #555;
					margin-top: 0.4em;
					font-size: 15px;
				...
				.col-sm-6 input[type='submit'], .col-sm-6 input[type='reset']{
					padding: 6px 12px;
					color: #555;
					margin-top: 0.25em;
					font-size: 14px;
				...
				.col-xs-12 input[type='submit'], .col-xs-12 input[type='reset']{
					padding: 5px 10px;
					color: #555;
					margin-top: 0.25em;
					font-size: 13px;
	...
	<div class="row">
		...
		<div class="container">
			<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
				<div width="300">
				    <div class="hovereffect">
				        <img class="img-responsive" src="images/cookies2.jpg" alt="" style="padding: 5%;">
			            <div class="overlay">
			                <h2>Cookies</h2>
							<table class="table">
									<tr>
			...
			<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
				<div width="300">
				    <div class="hovereffect">
				        <img class="img-responsive" src="images/cookies.jpg" alt="" style="padding: 5%;">
			            <div class="overlay">
			                <h2>cookies</h2>
							<table class="table">
									<tr>
			...
			<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
				<div width="300">
				    <div class="hovereffect">
				        <img class="img-responsive" src="images/cookies3.jpg" alt="" style="padding: 5%;">
			            <div class="overlay">
			                <h2>cookies</h2>
							<table class="table">
									<tr>
			...
			<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
				<div width="300">
				    <div class="hovereffect">
				        <img class="img-responsive" src="images/cookies4.jpg" alt="" style="padding: 5%;">
			            <div class="overlay">
			                <h2>cookies</h2>
							<table class="table">
									<tr>
			...
			<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
				<div width="300">
				    <div class="hovereffect">
				        <img class="img-responsive" src="images/cookies5.jpg" alt="" style="padding: 5%;">
			            <div class="overlay">
			                <h2>cookies</h2>						
							<table class="table">
									<tr>
			...
			<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
				<div width="300">
				    <div class="hovereffect">
				        <img class="img-responsive" src="images/cookies6.jpg" alt="" style="padding: 5%;">
			            <div class="overlay">
			                <h2>Cookies</h2>
							<table class="table">
									<tr>
